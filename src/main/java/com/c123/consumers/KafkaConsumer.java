...
public class KafkaConsumer {
        ...
        public static void main(String[] args) {
            try {
                int i = 0;
                org.apache.kafka.clients.consumer.KafkaConsumer<String, Event> consumer
                        = createConsumer();
        ...
        public static org.apache.kafka.clients.consumer.KafkaConsumer<String, Event> createConsumer() {
            ...
            return new org.apache.kafka.clients.consumer.KafkaConsumer<String, Event>(props);
        }
